    ...
    $.fn.mtimer = function(opts){
		...
		var picker = {
			...
			renderHTML : function(){
				...
				var html = '<div class="mt_mask"></div><div id="mtimer" class="mt_poppanel"><div class="mt_panel"><h3 class="mt_title">请选择时间</h3><h5>可选时间：11：00 - 12：00  17：00-18：00</h5> <div class="mt_body"><div class="mt_date"><ul><li class="mt_note"> </li><li></li></ul></div><div class="mt_time"><ul><li class="mt_note"> </li><li></li></ul></div><div class="mt_indicate"></div></div><div class="mt_confirm"><a href="javascript:void(0);" class="mt_ok">确定</a> <a href="javascript:void(0);" class="mt_cancel">取消</a></div></div></div>';
